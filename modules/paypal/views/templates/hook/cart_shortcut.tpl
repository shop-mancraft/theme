 ...
 *}
 ...
 <div data-container-express-checkout data-paypal-source-page='cart' class="mt-3 float-left">
 <form data-paypal-payment-form-cart class="paypal_payment_form" action="{$action_url|escape:'htmlall':'UTF-8'}" title="{l s='Pay with PayPal' mod='paypal'}" method="post" data-ajax="false">
     ...
     <img src="{$PayPal_img_esc|escape:'htmlall':'UTF-8'}" data-paypal-shortcut-btn alt="{l s='PayPal' mod='paypal'}" class="cursor-pointer"/>
 </form>
</div>
