            ...
            {foreach from=$catTree['children'] item=tree}
              ...
              <br>
	              ...
	              <br>
		              ...
		              <span style="margin-left:30px;">
		              <input type="checkbox" class="tree" id="tree_{$tree3['id']|escape:'htmlall':'UTF-8'}" value="{$tree3['id']|escape:'htmlall':'UTF-8'}">
		                {$tree3['name']|escape:'htmlall':'UTF-8'}
		              </span>
		              <br>
		              {/foreach}
              {/foreach}
...
<script type="text/javascript">
  setTimeout(function () {
        $(".tree").not('.noUniform').uniform();
        $.uniform.restore(".tree");
    }, 1000);
</script>
{/if}
