          ...
          {foreach from=$all_products item=product name=product}
            <tr>
                ...
                <td class="min-tablet-p">
                    <div class="price">
                    <span class="line-through text-red-600 mr-3">{if($product.default_currency_sign !== 'zł')}{$product.default_currency_sign|escape:'htmlall':'UTF-8'}{/if}{Product::getPriceStatic($product['id_product'], true, null, 2, null, false, true, 1, true, null, null, null, $nothing, true, false, null)|number_format:2} {if($product.default_currency_sign === 'zł')}{$product.default_currency_sign|escape:'htmlall':'UTF-8'}{/if}</span>
                        {if($product.default_currency_sign !== 'zł')}{$product.default_currency_sign|escape:'htmlall':'UTF-8'}<span id="price_{$product.id_product|escape:'htmlall':'UTF-8'}">{$product.price|number_format:2}</span> {if($product.default_currency_sign === 'zł')}{$product.default_currency_sign|escape:'htmlall':'UTF-8'}{/if}
                    </div>
                </td>
                <td class="desktop	">
