        ...
        <tbody id="fmm_table_body">
          {foreach from=$all_products item=product name=product}
            <tr>
                ...
                <td class="max-desktop	">{$product.default_currency_sign|escape:'htmlall':'UTF-8'}<span id="price_{$product.id_product|escape:'htmlall':'UTF-8'}">{$product.price|number_format:2}</span></td>
                <td class="max-desktop	">
