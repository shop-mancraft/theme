                    ...
                    <div class="product-container">
                        ...
                        <div class="product-description">
                            ...
                            <p class="form-group">
                                ...
                                <input class="form-control text-black" type="text" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$wishlist.quantity|intval}" size="3" />
                            </p>
                            ...
                            <p class="form-group">
                                ...
                                <select id="priority_{$product.id_product}_{$product.id_product_attribute}" class="form-control text-black grey">
                                ...
                                {foreach name=wl from=$wishlists item=wishlist}
                                    {if $smarty.foreach.wl.first}
                                        <p class="form-group">
                                            ...
                                            <select id="move_{$product.id_product}_{$product.id_product_attribute}" class="form-control text-black">
                                                <option>
            ...
            <div class="modal-content">
                        ...
                        <fieldset>
                            <div class="form-group row">
                                <label for="email1" class="col-md-3 form-control-label required">
                                    {l s='Email' mod='ttproductwishlist'}
                                </label>
                                <div class="col-md-9">
                            ...
                            {section name=i loop=4 start=2}
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" name="email{$smarty.section.i.index}" title="email_s{$smarty.section.i.index}" id="email{$smarty.section.i.index}" type="email">
                                    </div>
                                </div>
                            {/section}
                        </fieldset>
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitTtWishlist" class="btn btn-primary" type="submit" name="submitWishlist" onclick="WishlistSend('wl_send', '{$id_wishlist}', 'email');">
                        <i class="fa fa-spinner fa-pulse hide-if-not-loading"></i>
                        <span>{l s='Send' mod='ttproductwishlist'}</span>
                    </button>
                    {literal}
                        <style>.hide-if-not-loading{display:none;}.loading .hide-if-not-loading{display:block;}</style>    
                    {/literal}
                </div>
            </div>
        </div>
