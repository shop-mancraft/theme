...
<section class="new-products clearfix mt-3 hidden tablet-wide:dekstop">
  ...
  {l s='All new products' d='Shop.Theme.Catalog'}<i class="material-icons">keyboard_arrow_right</i>
  </a>
  </div>
</section>
