...
<div class="ps_languageselector cursor-pointer float-right text-center relative m-4 tablet-narrow:my-1 mx-2 tablet-narrow:mx-0 flex-auto">
  <div class="language-selector-wrapper">
    ...
    <div class="language-selector dropdown js-dropdown">
      <button data-toggle="dropdown" class="text-black hover:text-main hidden tablet:block" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}">
        <span class="expand-more text-[19px] transition font-normal">{$current_language.name_simple}</span>
