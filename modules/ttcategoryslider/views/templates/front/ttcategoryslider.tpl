...
<div class="overflow-hidden mb-10 tablet:mb-20">
	<div class="container relative">
		...
		<div class=" mt-5 tablet:mt-10 flex justify-center gap-5 flex-wrap">
			<a href="/{$language.iso_code}/cms/b2b-mancraft-client" class="flex items-center =text-white text-lg p-4 py-3 border border-white rounded-full hover:text-white hover:bg-main hover:border-main ">
				<svg class="mr-2 block " width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
