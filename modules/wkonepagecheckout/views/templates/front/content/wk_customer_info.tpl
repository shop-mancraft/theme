        ...
        <div class="wk-form-group !mb-0">
            ...
            <div class="form-group !mb-2">
                <input value="{if isset($wkguest)}{$wkguest->email}{/if}" maxlength="128" type="text" name="wk-email"
                    id="wk-email" placeholder="{l s='Email' mod='wkonepagecheckout'}"  class="form-control text-sm border-gray-2000 border-solid border rounded-full bf-gray-normal h-[50px] tablet:h-10">
                ...
                <div class="form-group">
                    <span>
						<label class="text-xs text-gray-dark">
							<input type="checkbox" value="1" name="wk-create-account" id="wk-create-account" class="mr-2 bf-gray-normal border-2 border-gray-3000 border-solid checked:bg-main-dark checked:focus:bg-main-dark checked:hover:bg-main-dark focus:ring-0 focus:ring-transparent form-checkbox opacity-100 outline-none rounded transition">
            ...
            <div class="form-group wkpassword_div {if Configuration::get('WK_CHECKOUT_GUEST_ALLOW')}wkhide{/if}">
                <input maxlength="60" type="password" name="wk-password" id="wk-password" placeholder="{l s='Password' mod='wkonepagecheckout'}" class="form-control border-gray-2000 border-solid border rounded-full bf-gray-normal h-[50px] tablet:h-10">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xs-12 pad-right-0">
                            <select name="wk_day" id="wk_day" class="form-control bf-gray-normal border border-solid border-gray-2000 focus:border-gray-3000 focus:ring-0 font-body font-medium form-control-select form-select js-country pl-4 rounded-full w-full">
                        ...
                        <div class="col-md-4 col-xs-12 pad-right-0">
                            <select name="wk_month" id="wk_month" class="form-control bf-gray-normal border border-solid border-gray-2000 focus:border-gray-3000 focus:ring-0 font-body font-medium form-control-select form-select js-country pl-4 rounded-full w-full">
                        ...
                        <div class="col-md-4 col-xs-12 pad-right-0">
                            <select name="wk_year" id="wk_year" class="form-control bf-gray-normal border border-solid border-gray-2000 focus:border-gray-3000 focus:ring-0 font-body font-medium form-control-select form-select js-country pl-4 rounded-full w-full">
