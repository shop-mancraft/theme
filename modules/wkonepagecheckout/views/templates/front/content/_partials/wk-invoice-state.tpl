...
<div class="clearfix form-group">
    ...
    <select name="wk_invoice_address_state" class="form-control wk_address_state bg-white border border-[#64635D] focus:border-[#64635D] focus:ring-0 font-body font-medium form-control-select form-select js-country pl-4 rounded-full w-full" data-attr="invoice">
