...
<article class="swiper-slide product-miniature js-product-miniature product-grid relative desktop:mb-10 px-4 float-left tablet:w-3/12 phone-wide:w-1/2 w-full" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
