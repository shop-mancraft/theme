...
function productadditional(productId) {
 ...
 /* ---------------- start Templatetrip more menu ----------------------*/
    ...
    if (menu.length > max_elem) {
        $('.tt-menu-horizontal .main-menu .menu-content').append('<li class="level-1 more"><div class="more-menu"><span class="categories">More<i class="material-icons">add</i></span></div></li>');
    }
...
function display(view) {
    if (view == 'list') {
        ...
        var cols_count = $('#right-column, #left-column').length;
        if (cols_count == 2) {
            $('#js-product-list .products.product-thumbs .product-miniature').attr('class', 'product-miniature js-product-miniature product-grid relative px-4 float-left tablet:w-1/2 w-full');
        } else if (cols_count == 1) {
            $('#js-product-list .products.product-thumbs .product-miniature').attr('class', 'product-miniature js-product-miniature product-grid relative px-4 float-left tablet:w-3/12 phone-wide:w-1/2 w-full');
        } else {
            $('#js-product-list .products.product-thumbs .product-miniature').attr('class', 'product-miniature js-product-miniature product-grid relative px-4 float-left tablet:w-3/12 phone-wide:w-1/2 w-full');
        }
